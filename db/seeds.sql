...
INSERT INTO storage_areas (roomid, name, description) values (1, "storage ottoman", "the black leather storage ottoman");
INSERT INTO storage_areas (roomid, name, description) values (2, "cabinets over the stove", "cabinets over the stove");
